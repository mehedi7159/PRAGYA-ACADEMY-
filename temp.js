(() => {
  ...
  var firebase_applet_config_default = {
    projectId: "amazing-dragon-wx6pd",
    appId: "1:169458414411:web:6393abdb232f877148aece",
    apiKey: "AIzaSyAMQ0ekzMOEeVtDLjXyhlqDyD0zaF6txjk",
    authDomain: "amazing-dragon-wx6pd.firebaseapp.com",
    storageBucket: "amazing-dragon-wx6pd.firebasestorage.app",
    messagingSenderId: "169458414411",
    measurementId: ""
  };
  ...
  var cachedAccessToken = localStorage.getItem("drive_access_token");
  var tokenExpiry = parseInt(localStorage.getItem("drive_token_expiry") || "0", 10);
  if (cachedAccessToken && Date.now() > tokenExpiry) {
    cachedAccessToken = null;
    localStorage.removeItem("drive_access_token");
    localStorage.removeItem("drive_token_expiry");
  }
  var initAuth = (onAuthChange) => {
